...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  const administrationVisible=canManageAdministration(profile)||can("instructors")||can("employees")||can("programs")||can("admin"),allowed=pathname==="/admin"?administrationVisible:can(pathModule(pathname));
  return (
