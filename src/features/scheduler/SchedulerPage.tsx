"use client";
import {useEffect,useMemo,useRef,useState}from"react";import{PageHeader}from"@/components/ui/PageHeader";import{DEFAULT_RESOURCES}from"./data";import{assignLessonToStudentPTR,markLinkedPTRLessonAfterCheckout,resourceGroupKey,removeReservation,saveReservation,subscribeCancellations,subscribeReservations,subscribeResourceGroupOrder,subscribeResources,subscribeSnagBlocks,subscribeStudents,subscribeSchedulerSettings,updateFlightOperation,type StudentOption}from"./firestore";import type{ActivityType,Cancellation,SchedulerEvent,SchedulerResource}from"./types";import{DEFAULT_SCHEDULER_SETTINGS,type SchedulerSettings}from"./settings";
