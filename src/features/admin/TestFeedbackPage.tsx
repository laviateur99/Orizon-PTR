...
import { canViewTestFeedback } from "@/features/auth/types";
...
export function TestFeedbackPage() {
  ...
  const canView = canViewTestFeedback(profile);
  ...
  return <><PageHeader title="Commentaires de test" subtitle="Observations envoyées par les employés" /><section className="card">
    ...
    {!canView ? <p>Accès réservé au personnel formateur (instructeur, chef instructeur ou administrateur).</p> : <div className="test-feedback-list">
