...
export type TrainingQuoteTemplateLine={id:string;lineType:TrainingQuoteLineType;description:string;minimumQuantity?:number;quotedQuantity:number;unit:TrainingRateUnit;aircraftType?:string;qualifier?:TrainingQuoteLineQualifier;externalFee:boolean;optional:boolean;rateCategory?:TrainingRateCategory;rateSearchTerms?:string[];defaultUnitPrice?:number;fixedUnitPrice?:number;sourceNote?:string};
